...
class MenuButton extends React.Component {
  render() {
    return(
      <button onClick={this.props.toggleMenu} className="Button Header__menu-button" aria-haspopup="true" aria-controls="navigation" aria-expanded={this.props.menuActive ? 'true' : 'false'}>
